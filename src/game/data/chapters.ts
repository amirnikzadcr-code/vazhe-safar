...
export const CHAPTERS: ChapterTheme[] = [
  {
    ...
    ambient: "petals",
    music: { scale: "mahur", root: 293.66, cents: [], bpm: 92, meter: 4, perc: "daf", lead: "santur", octave: 1, drone: 0.45,
  ...
  },
  {
    ...
    ambient: "dust",
    music: { scale: "shur", root: 261.63, cents: [], bpm: 96, meter: 6, perc: "tombak", lead: "santur", octave: 0, drone: 0.5,
  ...
  },
  {
    ...
    ambient: "sand",
    music: { scale: "dashti", root: 220.0, cents: [], bpm: 72, meter: 4, perc: "tombak", lead: "ney", octave: 0, drone: 0.6,
  ...
  },
  {
    ...
    ambient: "fireflies",
    music: { scale: "nava", root: 246.94, cents: [], bpm: 60, meter: 6, perc: "none", lead: "ney", octave: 0, drone: 0.7,
  ...
  },
  {
    ...
    ambient: "snow",
    music: { scale: "chahargah", root: 293.66, cents: [], bpm: 100, meter: 4, perc: "daf", lead: "kamancheh", octave: 1, drone: 0.5,
  ...
  },
  {
    ...
    ambient: "dust",
    music: { scale: "homayun", root: 261.63, cents: [], bpm: 76, meter: 4, perc: "tombak", lead: "ney", octave: 0, drone: 0.6,
  ...
  },
  {
    ...
    ambient: "seasparkle",
    music: { scale: "rast", root: 293.66, cents: [], bpm: 90, meter: 6, perc: "daf", lead: "santur", octave: 1, drone: 0.45,
  ...
  },
  {
    ...
    ambient: "leaves",
    music: { scale: "abuata", root: 220.0, cents: [], bpm: 66, meter: 4, perc: "tombak", lead: "kamancheh", octave: 0, drone: 0.65,
  ...
  },
  {
    ...
    ambient: "stars",
    music: { scale: "segah", root: 220.0, cents: [], bpm: 56, meter: 4, perc: "none", lead: "ney", octave: 0, drone: 0.75,
  ...
  },
  {
    ...
    ambient: "gold",
    music: { scale: "mahur", root: 329.63, cents: [], bpm: 104, meter: 6, perc: "daf", lead: "santur", octave: 1, drone: 0.5,
