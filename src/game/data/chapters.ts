...
export const CHAPTERS: ChapterTheme[] = [
  {
    ...
    ambient: "petals",
    music: { scale: "mahur", root: 293.66, cents: [], bpm: 88, perc: true, density: 0.55, octaveBase: 1, drone: 0.5 },
  ...
  },
  {
    ...
    ambient: "dust",
    music: { scale: "shur", root: 261.63, cents: [], bpm: 92, perc: true, density: 0.6, octaveBase: 0, drone: 0.55 },
  ...
  },
  {
    ...
    ambient: "sand",
    music: { scale: "dashti", root: 220.0, cents: [], bpm: 76, perc: true, density: 0.45, octaveBase: 0, drone: 0.6 },
  ...
  },
  {
    ...
    ambient: "fireflies",
    music: { scale: "nava", root: 246.94, cents: [], bpm: 66, perc: false, density: 0.4, octaveBase: 0, drone: 0.7 },
  ...
  },
  {
    ...
    ambient: "snow",
    music: { scale: "chahargah", root: 293.66, cents: [], bpm: 96, perc: true, density: 0.6, octaveBase: 1, drone: 0.5 },
  ...
  },
  {
    ...
    ambient: "dust",
    music: { scale: "homayun", root: 261.63, cents: [], bpm: 80, perc: true, density: 0.5, octaveBase: 0, drone: 0.6 },
  ...
  },
  {
    ...
    ambient: "seasparkle",
    music: { scale: "rast", root: 293.66, cents: [], bpm: 84, perc: true, density: 0.55, octaveBase: 1, drone: 0.5 },
  ...
  },
  {
    ...
    ambient: "leaves",
    music: { scale: "abuata", root: 220.0, cents: [], bpm: 72, perc: false, density: 0.42, octaveBase: 0, drone: 0.65 },
  ...
  },
  {
    ...
    ambient: "stars",
    music: { scale: "segah", root: 220.0, cents: [], bpm: 60, perc: false, density: 0.38, octaveBase: 0, drone: 0.75 },
  ...
  },
  {
    ...
    ambient: "gold",
    music: { scale: "mahur", root: 329.63, cents: [], bpm: 100, perc: true, density: 0.65, octaveBase: 1, drone: 0.5 },
