...
import { Target, BookOpen, Sparkles, CalendarDays, Check, Coin } from "@/components/game/icons";
...
export function MissionsScreen({ coins, onBack, onChallenge }: { coins: number; onBack: () => void; onChallenge: () => void }) {
  const { data } = useSave();
